  ...
  return (
    <>
      ...
      <div className="center-container-alt">
        <div className="career-section airdrop-section flex flex-col mt-24 sh-p-12 relative">
      ...
      <div className="center-container-alt">
        <div className="career-section airdrop-frame flex flex-row mt-24 sh-p-12 relative space-x-8">
      ...
      <div className="center-container-alt">
      <div className="share-section share-section-alt bg-c-black grid grid-cols-2 mt-24 sh-p-12-alt relative">
        <div className="airdrop-card-alt p-8">
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className='grid justify-center'>
              <button className='brand-button brand-button-alt mt-8'>
        ...
        <div className="grid justify-center items-center download-img-position download-img-position-alt">
