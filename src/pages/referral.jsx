    ...
    <>
      ...
      <div class="mt-3 mx-auto px-2 sm:px-6 lg:px-8 h-18">
        <div className="center-container-alt">
          <div className="share-earn-banner share-earn-banner-alt flex flex-col justify-center items-center mt-24 sh-p-12-alt-n relative md:pt-8 md:pb-8 md:pr-20 md:pl-20 lg:pt-24 lg:pb-24 lg:pr-80 lg:pl-80">
          ...
          <div className="relative rounded-sm overflow-hidden mt-12 grid mb-12" style={{ maxWidth: "65%" }}>
            ...
            <div className=" grid grid-cols-2 gap-4 mt-8">
              <div className="grid grid-cols-2 gap-4">
                <div className="flex justify-center items-center flex-col pt-4 pl-4 pr-4 referral-rules-section-1">
                ...
                <div className="flex flex-col  pt-4 pl-4 pr-4 referral-rules-section-1">
                  <div className="relative">
              ...
              <div>
                <div className="flex flex-col  pt-4 pr-4 referral-rules-section-1">
                  <div className="relative mb-8 pb-8 pt-8 mt-8">
                    <img className="mx-auto mt-auto" src={RefferalGroup} alt="Referral Done"/>
                  </div>
                  <div className="relative pl-6">
                    <p className="referral-rules-section-1-text" style={{width: "15.375rem",}}>
            ...
            <div className="flex gap-4 mt-8">
              <div className="flex-auto w-64 referral-rules-section-2">
                <div className="relative">
            ...
            {!explain ? (
              ...
              <div className="flex gap-4 mt-8">
                ...
                <div className="flex-auto w-64 referral-rules-explain-section-details">
                  <div className="relative">
                    <div className="flex flex-col">
                      <div className="ml-6 mt-4 pt-4 mr-6 pr-6 gap-4 pb-4">
        ...
        <div className="container flex flex-col lg:grid lg:justify-center lg:grid-row-4 md:justify-center md:items-center space-y-12 lg:space-y-8 md:space-y-4 ">
