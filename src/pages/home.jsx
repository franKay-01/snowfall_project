  ...
  return (
    <>
      ...
      <div className="center-container-alt">
        ...
        <div className="share-section bg-c-black grid grid-cols-1 lg:grid-cols-2 md:grid-cols-1 justify-items-center content-center mt-24 sh-p-12 relative mb-8 lg:gap-8 md:gap-8">
          ...
          <div className="flex flex-col home-order-1 justify-center space-y-4 share-img-p-l md:pl-12 lg:pl-0">
            ...
            <div className="flex flex-col post-m space-y-4 lg:space-y-0 md:space-y-0 lg:flex-row md:flex-row lg:space-x-4 md:space-x-4">
      ...
      <div className="flex flex-col pl-4 pr-4 space-y-4 lg:flex-row md:flex-col md:justify-center md:items-center lg:flex-row lg:space-x-14 md:space-y-14 mt-24">
        <div id="slider">  
      ...
      <div className="bg-c-black relative">
        ...
        {forCommunity ? 
          <div className="bg-c-black flex flex-col mt-8 lg:mt-0 md:mt-0 lg:justify-center lg:items-stretch md:justify-center md:items-center lg:pt-0 md:pt-8 lg:pb-0 md:pb-12 md:flex-col lg:flex-row lg:space-x-24 lg:space-y-2 space-y-4 md:space-y-14">
            <div className="relative flex flex-col justify-center space-y-4 md:space-y-12 lg:space-y-12">
              <div className="relative lg:absolute md:absolute lg:top-44 md:top-44 snowball-money-section grid grid-cols-2">
            ...
            <div className="w-80 flex flex-row space-x-4">
        ...
        <div className="bg-c-black flex flex-col mt-8 lg:mt-0 md:mt-0 lg:justify-center lg:items-stretch md:justify-center md:items-center lg:pt-0 md:pt-8 lg:pb-0 md:pb-12 md:flex-col lg:flex-row lg:space-x-24 lg:space-y-2 space-y-4 md:space-y-14">
          <div className="relative flex flex-col justify-center space-y-4 md:space-y-12 lg:space-y-12">
            <div className="relative lg:absolute md:absolute lg:top-44 md:top-44 snowball-money-section grid grid-cols-2">
              ...
              <h1 className="snowball-money-button-text cursor-pointer" onClick={()=>setForCommunity(true)}>Community</h1>
            </div>
            <div className="pl-4">
              <h1 className="snowball-money-header">
                In their own words
            ...
            <button className="hidden lg:block md:hidden snowball-money-view-open-roles">
              <h1 className="snowball-money-view-open-roles-text">
                View Open Roles
              </h1>
            </button>
          </div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 space-x-0 space-y-4 md:space-y-0 lg:space-y-0 md:space-x-4 lg:space-x-4'>
                <div className="brand-input-box brand-input-box-alt flex flex-row">
                  ...
                  <input value={twitter} onChange={(event) => setTwitter(event.target.value)} className='main-input-box'  placeholder="Twitter Handle"/>
                </div>
                <div className="brand-input-box brand-input-box-alt flex flex-row">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <input value={tiktok} onChange={(event) => setTiktok(event.target.value)} className='main-input-box'  placeholder="Tiktok Handle"/>
                </div>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 space-x-0 space-y-4 md:space-y-0 lg:space-y-0 md:space-x-4 lg:space-x-4'>
                <div className="brand-input-box brand-input-box-alt flex flex-row">
                  ...
                  <input value={instagram} onChange={(event) => setInstagram(event.target.value)} className='main-input-box'  placeholder="Instagram Handle"/>
                </div>
                <div className="brand-input-box brand-input-box-alt flex flex-row">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <input value={youtube} onChange={(event) => setYoutube(event.target.value)} className='main-input-box'  placeholder="YouTube Channel"/>
                </div>
              </div>
              <div className='grid justify-center'>
                <button className='brand-button mt-8' onClick={submitAmbassardorshipForm}>
