      ...
      >
        ...
        <div className=" grid grid-cols-2 gap-4 mt-8">
          <div className="grid grid-cols-2 gap-4">
            <div
              className="flex justify-center items-center flex-col pt-4 pl-4 pr-4"
              style={{
                width: "100%",
                // height: "22.5rem",
                flexShrink: 0,
            ...
            <div
              className="flex flex-col  pt-4 pl-4 pr-4"
              style={{
                width: "100%",
                // height: "22.5rem",
                flexShrink: 0,
              ...
              <div className="flex flex-row relative">
                <div className="ml-6 mt-4 pt-4 mr-6 pr-6 gap-4 pb-4">
                  <p className="text-base w-72 font-semibold text-white leading-6">
                    New users must sign up using the referral code in order to
                    be{" "}
                    <span className="referral-program-sub-text-color">
            ...
            >
              ...
              <div className="flex flex-col m-4">
                <div className="relative mb-2 pl-6">
                  ...
                  >
                    The platform reserves the right to modify these rules at any
                    time{" "}
                    <span className="referral-program-sub-text-color">
        ...
        <div className=" grid grid-cols-3 gap-4 mt-8">
          ...
          >
            ...
            >
              The referral program is subject to change or termination at any
              time at the discretion of the platform
            </p>
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              ...
              appropriate action if it detects fraudulent or abusive behavior
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              regulations related to the referral program
            </p>
          </div>
        </div>
        
        {
          ...
          >
            ...
            >Explanation of reward system  </p> 
            <img style={{
              height: "1.5rem",
              width: "1.5rem"
            }} src={ArrowRight} alt="Icon Arrow Right"/>
      </div>
            ...
            <div className="flex flex-col">
              <div className="ml-6 mt-4 pt-4 mr-6 pr-6 gap-4 pb-4">
                ...
                <p className="text-sm mb-2 font-light leading-5">
                  ...
                  referrer will receive 90% of the fees generated by their
                  referral.
                </p>
                <p className="text-sm font-light mb-2 leading-5">
                  For example, if a new user generates $100 in fees through
                  trading, depositing into indexes, or staking, the referrer
                  will receive $90 as a reward.{" "}
                </p>
                <p className="text-sm font-light mb-2 leading-5">
                  It's important to note that the actual amount of the reward
                  may vary depending on the activities of the new user and may
                  be subject to change. The referrer should periodically check
                  the terms and conditions of the referral program for any
                  updates.{" "}
                </p>

                <p className="text-sm font-light mb-2 leading-5">
                  The referral rewards will be awarded to the referrer for the
                  life of the app or until the referral program is terminated
                  by the platform. This means that as long as the new user
                  continues to generate fees through trading, depositing into
                  indexes, or staking, the referrer will continue to receive a
                  percentage of the fees.{" "}
                </p>

                <p className="text-sm font-light mb-2 leading-5">
                  It's important to note that the platform reserves the right
                  to terminate the referral program at any time, without prior
                  notice. In such an event, the referrer will no longer be
